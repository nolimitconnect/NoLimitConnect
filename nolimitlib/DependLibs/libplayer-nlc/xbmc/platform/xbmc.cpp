...
extern "C" int XBMC_Run( bool renderGUI )
{
	...
	if ( g_KodiIsRunning )
	{
		CMessagePrinter::DisplayError("player-nlc is already running");
    ...
    {
        CMessagePrinter::DisplayError( "ERROR: Unable to create player-nlc applet" );
        return status;
    }
    ...
    {
        LogMsg( LOG_ERROR, "ERROR: Media Player unable to create GUI. Exiting" );
        g_application.toGuiMediaError( eMediaErrorPlayerInit, "ERROR: Media Player unable to create GUI. Exiting" );
    ...
    {
        LogMsg( LOG_ERROR, "ERROR: Media Player unable to Initialize. Exiting" );
        g_application.toGuiMediaError( eMediaErrorPlayerInit, "ERROR: Media Player unable to Initialize. Exiting" );
        return status;
    }
