...
{
  return std::make_unique<CSlideShowPicQt>();
}

void CSlideShowPicQt::Render(float* x, float* y, CTextureBase* pTexture, UTILS::COLOR::Color color)
{
