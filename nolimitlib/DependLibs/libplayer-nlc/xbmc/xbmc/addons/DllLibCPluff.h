...
public:
    ...
    void set_fatal_error_handler( cp_fatal_error_func_t p1 ) override;
    cp_status_t init() override;
    void destroy() override;
    cp_context_t* create_context( cp_status_t *p1 ) override;
    void destroy_context( cp_context_t *p1 ) override;

    cp_status_t register_pcollection( cp_context_t *p1, const char *p2 ) override;
    void unregister_pcollection( cp_context_t *p1, const char *p2 ) override;
    void unregister_pcollections( cp_context_t *p1 ) override;

    cp_status_t register_logger( cp_context_t *p1, cp_logger_func_t p2, void *p3, cp_log_severity_t p4 ) override;
    void unregister_logger( cp_context_t *p1, cp_logger_func_t p2 ) override;
    cp_status_t scan_plugins( cp_context_t *p1, int p2 ) override;
    cp_plugin_info_t* get_plugin_info( cp_context_t *p1, const char *p2, cp_status_t *p3 ) override;
    cp_plugin_info_t** get_plugins_info( cp_context_t *p1, cp_status_t *p2, int *p3 ) override;
    cp_extension_t** get_extensions_info( cp_context_t *p1, const char *p2, cp_status_t *p3, int *p4 ) override;
    void release_info( cp_context_t *p1, void *p2 ) override;

    cp_cfg_element_t* lookup_cfg_element( cp_cfg_element_t *p1, const char *p2 ) override;
    char* lookup_cfg_value( cp_cfg_element_t *p1, const char *p2 ) override;

    cp_status_t define_symbol( cp_context_t *p1, const char *p2, void *p3 ) override;
    void* resolve_symbol( cp_context_t *p1, const char *p2, const char *p3, cp_status_t *p4 ) override;
    void release_symbol( cp_context_t *p1, const void *p2 ) override;
    cp_plugin_info_t* load_plugin_descriptor( cp_context_t *p1, const char *p2, cp_status_t *p3 ) override;
    cp_plugin_info_t* load_plugin_descriptor_from_memory( cp_context_t *p1, const char *p2, unsigned int p3, cp_status_t *p4 ) override;
    cp_status_t uninstall_plugin( cp_context_t *p1, const char *p2 ) override;
};
