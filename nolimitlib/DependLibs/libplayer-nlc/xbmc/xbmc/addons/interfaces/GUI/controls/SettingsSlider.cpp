                                                     ...
                                                     bool visible)
{
  ...
  {
    CLog::Log(LOGERROR,
              "Interface_GUIControlSettingsSlider::%s - invalid handler data (kodiBase='%p', handle='%p') "
                "on addon '%s'",
                                                  ...
                                                  const char* text)
{
  ...
  {
    CLog::Log(LOGERROR,
              "Interface_GUIControlSettingsSlider::%s - invalid handler data (kodiBase='%p', "
              "handle='%p', text='%p') on addon '%s'",
