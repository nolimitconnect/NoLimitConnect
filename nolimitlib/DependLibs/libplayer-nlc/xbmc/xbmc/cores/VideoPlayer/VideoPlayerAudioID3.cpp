...
#include <libtag/id3v2framefactory.h>
#include <libtag/mpegfile.h>
#include <libtag/tbytevectorstream.h>
...
void CVideoPlayerAudioID3::CloseStream(bool bWaitForBuffers)
{
  ...
  LogModule( eLogPlayerNlc, LOG_DEBUG, "Audio ID3 tag processor - waiting for data thread to exit");
  StopThread();
