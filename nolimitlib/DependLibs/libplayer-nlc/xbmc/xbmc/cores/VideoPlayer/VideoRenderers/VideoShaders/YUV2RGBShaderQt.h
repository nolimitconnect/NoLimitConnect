...
namespace Shaders {
    ...
    public:
        ...
        ~BaseYUV2RGBShaderQt();
        void                    SetField( int field ) override   { BaseYUV2RGBShader::SetField( field ); }
        void                    SetWidth( int w ) override      { BaseYUV2RGBShader::SetWidth( w );  }
        void                    SetHeight( int h ) override     { BaseYUV2RGBShader::SetHeight( h );  }
