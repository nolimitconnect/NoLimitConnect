...
namespace OVERLAY {
    ...
    {
    public:
        explicit COverlayTextureQt( const CDVDOverlayImage& o, CRect& rSource );
        explicit COverlayTextureQt( const CDVDOverlaySpu& o );
    ...
    {
    public:
        COverlayGlyphQt( ASS_Image* images, float width, float height );
