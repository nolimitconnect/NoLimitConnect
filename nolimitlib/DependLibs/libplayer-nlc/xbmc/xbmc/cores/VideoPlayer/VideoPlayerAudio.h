...
public:
  ...
  void                          setPlayerQueueFull( bool queueFull ) override    { m_PlayerQueueFull = queueFull; }
  bool                          getIsPlayerQueueFull( void ) override            { return m_PlayerQueueFull; }
