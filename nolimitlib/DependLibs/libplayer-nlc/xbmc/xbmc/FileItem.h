...
#else
  bool IsEPG() const { return false; }
  bool IsPVRChannel() const { return false; }
  bool IsPVRChannelGroup() const { return false; }
  bool IsPVRRecording() const { return false; }
  bool IsUsablePVRRecording() const  { return false; }
  bool IsDeletedPVRRecording() const { return false; }
  bool IsInProgressPVRRecording() const { return false; }
  bool IsPVRTimer() const  { return false; }
#endif // ENABLE_PVR
