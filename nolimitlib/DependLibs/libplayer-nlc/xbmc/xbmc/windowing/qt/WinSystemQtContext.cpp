...
void CWinSystemQtContext::Register()
{
  KODI::WINDOWING::CWindowSystemFactory::RegisterWindowSystem( CreateWinSystem, "qt" );
}

std::unique_ptr<CWinSystemBase> CWinSystemQtContext::CreateWinSystem()
{
...
std::unique_ptr<CVideoSync> CWinSystemQtContext::GetVideoSync(CVideoReferenceClock* clock)
{
