...
public:
  ...
  static bool IsCurrentThread(const ThreadIdentifierKodi tid);
  static ThreadIdentifierKodi GetCurrentThreadId();
  static ThreadIdentifierKodi GetDisplayThreadId(const ThreadIdentifierKodi tid);
...
private:
  ...
  // These are platform specific and can be found in ./platform/[platform]/ThreadImpl.cpp
  // -----------------------------------------------------------------------------------
  ThreadIdentifierKodi ThreadId() const;
  void SetThreadInfo();
  void TermHandler();
  ...
  ThreadIdentifierKodi m_ThreadId;
