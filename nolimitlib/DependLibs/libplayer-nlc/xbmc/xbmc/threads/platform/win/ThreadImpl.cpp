...
ThreadIdentifierKodi CThread::GetCurrentThreadId()
{
  return ::GetCurrentThreadId();
}

ThreadIdentifierKodi CThread::GetDisplayThreadId(const ThreadIdentifierKodi tid)
{
  return tid;
}

bool CThread::IsCurrentThread(const ThreadIdentifierKodi tid)
{
...
{
  unsigned int iTime = XbmcThreadsNoChrono::SystemClockMillis();
