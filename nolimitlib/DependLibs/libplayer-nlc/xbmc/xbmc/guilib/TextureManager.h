...
public:
  ...
  void Add(std::shared_ptr<CTextureBase> texture, int delay);
  void Set(std::shared_ptr<CTextureBase> texture, int width, int height);
  void Free();
  unsigned int size() const;

  std::vector<std::shared_ptr<CTextureBase>> m_textures;
...
public:
  ...
  void Add(std::unique_ptr<CTextureBase> texture, int delay);
  bool Release();
