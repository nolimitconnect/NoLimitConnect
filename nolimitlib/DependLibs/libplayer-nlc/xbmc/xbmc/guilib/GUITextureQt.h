...
public:
    ...
    static void                 DrawQuad( const CRect &coords, UTILS::COLOR::Color color, CTextureBase *texture = NULL, const CRect *texCoords = NULL );

    CGUITextureQt*              Clone() const override;
