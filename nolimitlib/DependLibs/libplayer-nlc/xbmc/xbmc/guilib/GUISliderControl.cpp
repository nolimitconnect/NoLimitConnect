...
CGUISliderControl::CGUISliderControl(int parentID,
  ...
  : CGUIControl(parentID, controlID, posX, posY, width, height),
    ...
    m_guiBackgroundDisabled(
        CGUITextureBase::CreateTexture(posX, posY, width, height, backGroundTextureDisabled)),
    m_guiSelectorLower(CGUITextureBase::CreateTexture(posX, posY, width, height, nibTexture)),
    m_guiSelectorUpper(CGUITextureBase::CreateTexture(posX, posY, width, height, nibTexture)),
    m_guiSelectorLowerFocus(CGUITextureBase::CreateTexture(posX, posY, width, height, nibTextureFocus)),
    m_guiSelectorUpperFocus(CGUITextureBase::CreateTexture(posX, posY, width, height, nibTextureFocus)),
    m_guiSelectorLowerDisabled(
        CGUITextureBase::CreateTexture(posX, posY, width, height, nibTextureDisabled)),
...
void CGUISliderControl::Process(unsigned int currentTime, CDirtyRegionList &dirtyregions)
{
  ...
  CGUITextureBase* nibLower = nullptr;
  ...
  if (m_rangeSelection)
  {
    CGUITextureBase* nibUpper = nullptr;
...
bool CGUISliderControl::ProcessSelector(CGUITextureBase* background,
                                        CGUITextureBase* nib,
