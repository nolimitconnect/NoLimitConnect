...
CGUIRangesControl::CGUIRange::CGUIRange(float fPosX,
  ...
  : m_guiLowerTexture(CGUITextureBase::CreateTexture(fPosX, fPosY, fWidth, fHeight, lowerTextureInfo)),
    m_guiFillTexture(CGUITextureBase::CreateTexture(fPosX, fPosY, fWidth, fHeight, fillTextureInfo)),
    m_guiUpperTexture(CGUITextureBase::CreateTexture(fPosX, fPosY, fWidth, fHeight, upperTextureInfo)),
