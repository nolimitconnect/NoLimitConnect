...
std::unique_ptr<CTextureBase> CGUIFontTTFQt::ReallocTexture( unsigned int& newHeight )
{
    newHeight = CTextureBase::PadPow2( newHeight );

    std::unique_ptr<CTextureBase> newTexture = std::make_unique<CTextureBase>( m_textureWidth, newHeight, XB_FMT_A8 );
