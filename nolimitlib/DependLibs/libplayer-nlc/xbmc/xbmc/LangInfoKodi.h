...
public:
  ...
  */
  ...
  // renamed from GetDateFormat because of microsoft substitution of GetDateFormat to GetDateFormatA
  const std::string& GetLanguageDateFormat(bool bLongDate = false) const;
  ...
  // renamed from GetTimeFormat because of microsoft substitution of GetTimeFormat to GetTimeFormatA
  const std::string& GetLanguageTimeFormat() const;
