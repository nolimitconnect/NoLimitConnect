...
//============================================================================
void CApplication::fromGuiResizeBegin( EAppModule appModule, int winWidth, int winHeight )
{
	/*
	if( CServiceBroker::GetWinSystem() )
	{
...
//============================================================================
void CApplication::fromGuiResizeEvent( EAppModule appModule, int winWidth, int winHeight )
{
	/*
    if( CServiceBroker::GetWinSystem() )
    {
...
//============================================================================
void CApplication::fromGuiResizeEnd( EAppModule appModule, int winWidth, int winHeight )
{
	if( CServiceBroker::GetWinSystem() )
	{
		XBMC_Event msg{ XBMC_VIDEORESIZE };
...
{
    GetToGui().toGuiMediaError( eAppModulePlayerNlc, mediaError, msg );
}
