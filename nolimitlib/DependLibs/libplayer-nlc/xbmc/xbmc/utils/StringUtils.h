...
#include <libplayer-nlc/xbmc/xbmc/fmt/format.h>
...
#include <libplayer-nlc/xbmc/xbmc/XBDateTime.h>
#include <libplayer-nlc/xbmc/xbmc/utils/params_check_macros.h>
...
// for more info https://connect.microsoft.com/VisualStudio/feedback/details/2655363
   ...
   */
  static uint32_t ToUint32(std::string str, uint32_t fallback = 0) noexcept;
   ...
   * \return The converted number, otherwise fallback if conversion fails
   */
  static uint64_t ToUint64(std::string str, uint64_t fallback = 0) noexcept;
   ...
   * \return The converted number, otherwise fallback if conversion fails
   */
  static float ToFloat(std::string str, float fallback = 0.0f) noexcept;
