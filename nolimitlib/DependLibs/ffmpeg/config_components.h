...
#endif // #endif // defined(TARGET_OS_WINDOWS)
...
#define CONFIG_SNDIO_OUTDEV 0 // nlc will handle sound output
...
#if defined(TARGET_OS_WINDOWS)
#define CONFIG_RANDOM_FILTER 0 // missing definition of random_class so disabled
#else
