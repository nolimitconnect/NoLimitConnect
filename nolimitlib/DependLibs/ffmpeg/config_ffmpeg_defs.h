#ifndef CONFIG_FFMPEG_DEFS_H
#define CONFIG_FFMPEG_DEFS_H

#define CONFIG_FFMPEG_H 1 // used for include/exclude compile templates
// modified for nlc
// NOTE: if you change this header you must change config_x86_ffmpeg.asm to match

#define FF_API_OLD_CHANNEL_LAYOUT 1 // FIXME setup mask so layout works without this define
...
#define FFMPEG_DATADIR "/home/nolimit/ffmpegCheckout/ffmpeg_build/share/ffmpeg"
#define AVCONV_DATADIR "/home/nolimit/ffmpegCheckout/ffmpeg_build/share/ffmpeg"
...
// #define HAVE_FCNTL 1 // defined in NlcCompilerConfig
...
// already defined #define HAVE_STRUCT_POLLFD 1
...
#if defined(TARGET_OS_WINDOWS)
#define CONFIG_FDCTDSP 0 // requires inline assembly which is not implemented in visual studio x64
#else
