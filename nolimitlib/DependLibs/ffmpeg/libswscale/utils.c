...
#include "rgb2rgb_swscale.h"
#include "swscale_swscale.h"
...
static void fill_rgb2yuv_table(SwsContext *c, const int table[4], int dstRange)
{
    ...
    if(/*!dstRange && */!memcmp(table, ff_yuv2rgb_coeffs_swscale[SWS_CS_DEFAULT], sizeof(ff_yuv2rgb_coeffs_swscale[SWS_CS_DEFAULT]))) {
                                           ...
                                           SwsFilter *dstFilter)
{
    ...
    if (!c->contrast && !c->saturation && !c->dstFormatBpp)
        sws_setColorspaceDetails(c, ff_yuv2rgb_coeffs_swscale[SWS_CS_DEFAULT], c->srcRange,
                                 ff_yuv2rgb_coeffs_swscale[SWS_CS_DEFAULT],
