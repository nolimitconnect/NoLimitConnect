...
#include "hwconfig.h"
#include "mpeg_er.h"
#include "mpegvideo_avcodec.h"
#include "mpegvideodec.h"
#include "msmpeg4_vc1_data.h"
#include "profiles.h"
#include "simple_idct_avcodec.h"
#include "vc1.h"
#include "vc1data.h"
...
const FFCodec ff_vc1_decoder = {
    ...
    .hw_configs     = (const AVCodecHWConfigInternal *const []) {
                        ...
                        HWACCEL_NVDEC(vc1),
#endif
#if CONFIG_VC1_VAAPI_HWACCEL && CONFIG_VAAPI
                        HWACCEL_VAAPI(vc1),
#endif
#if CONFIG_VC1_VDPAU_HWACCEL && CONFIG_VDPAU
                        HWACCEL_VDPAU(vc1),
#endif
                        NULL
                    },
...
const FFCodec ff_wmv3_decoder = {
    ...
    .hw_configs     = (const AVCodecHWConfigInternal *const []) {
                        ...
                        HWACCEL_NVDEC(wmv3),
#endif
#if CONFIG_WMV3_VAAPI_HWACCEL && CONFIG_VAAPI
                        HWACCEL_VAAPI(wmv3),
#endif
#if CONFIG_WMV3_VDPAU_HWACCEL && CONFIG_VDPAU
                        HWACCEL_VDPAU(wmv3),
#endif
                        NULL
                    },
