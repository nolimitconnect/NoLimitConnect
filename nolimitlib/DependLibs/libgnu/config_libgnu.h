...
/* #undef ABSOLUTE_LIBC_GNUROCO_0_6_LIBC_GNUROCO_LIBC_GNUROCO_CONFIG_H */
...
libc. */
#define HAVE_COPYSIGNF_IN_LIBC_GNU 1

/* Define if the copysignl function is declared in <math.h> and available in
libc. */
#define HAVE_COPYSIGNL_IN_LIBC_GNU 1

/* Define if the copysign function is declared in <math.h> and available in
libc. */
#define HAVE_COPYSIGN_IN_LIBC_GNU 1
...
#define HAVE_ISNAND_IN_LIBC_GNU 1

/* Define if the isnan(float) function is available in libc. */
#define HAVE_ISNANF_IN_LIBC_GNU 1

/* Define if the isnan(long double) function is available in libc. */
#define HAVE_ISNANL_IN_LIBC_GNU 1
...
header file. */
/* #undef HAVE_LIBC_GNUROCO_0_6_LIBC_GNUROCO_LIBC_GNUROCO_CONFIG_H */
