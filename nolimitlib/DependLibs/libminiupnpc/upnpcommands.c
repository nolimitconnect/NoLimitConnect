                           ...
                           struct PortMappingParserData * data)
{
	...
	/*if(p) {
		LogCModule( MODULE_PORT_FORWARD, LOG_DEBUG, "NewPortListing : %s\n", p);
	}*/
	/*LogCModule( MODULE_PORT_FORWARD, LOG_DEBUG, "NewPortListing(%d chars) : %s\n",
	...
	if(pdata.portListing)
	{
		...
		{
			LogCModule( MODULE_PORT_FORWARD, LOG_DEBUG, "%2d %s %5hu->%s:%-5hu '%s' '%s'\n",
	...
	/*LogCModule( MODULE_PORT_FORWARD, LOG_DEBUG, "%.*s", bufsize, buffer);*/
