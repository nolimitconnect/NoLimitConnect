...
/*! \brief TIME_FORMAT enum/bitmask used for formatting time strings
 ...
 \sa VxStringUtils::SecondsToTimeString
 */
enum VX_TIME_FORMAT {
    VX_TIME_FORMAT_GUESS       =  0,
    VX_TIME_FORMAT_SS          =  1,
    VX_TIME_FORMAT_MM          =  2,
    VX_TIME_FORMAT_MM_SS       =  3,
    VX_TIME_FORMAT_HH          =  4,
    VX_TIME_FORMAT_HH_SS       =  5, // not particularly useful
    VX_TIME_FORMAT_HH_MM       =  6,
    VX_TIME_FORMAT_HH_MM_SS    =  7,
    VX_TIME_FORMAT_XX          =  8, // AM/PM
    VX_TIME_FORMAT_HH_MM_XX    = 14,
    VX_TIME_FORMAT_HH_MM_SS_XX = 15,
    VX_TIME_FORMAT_H           = 16,
    VX_TIME_FORMAT_H_MM_SS     = 19,
    VX_TIME_FORMAT_H_MM_SS_XX  = 27};
...
public:
  ...
  */
  ...
  /*! \brief convert a time in seconds to a string based on the given time format
   ...
   \sa TIME_FORMAT
   */
  static std::string SecondsToTimeString(long seconds, VX_TIME_FORMAT format = VX_TIME_FORMAT_GUESS);
