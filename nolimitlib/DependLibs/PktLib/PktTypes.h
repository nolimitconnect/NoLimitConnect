...
#define PKT_TYPE_PUSH_TO_TALK_START					( PKT_TYPE_PUSH_TO_TALK_REPLY	+ 1 )           // 105 ( 0x69 ) 
#define PKT_TYPE_PUSH_TO_TALK_STOP					( PKT_TYPE_PUSH_TO_TALK_START	+ 1 )           // 106 ( 0x6A )
// 107 ( 0x6B ) 																					
#define PKT_TYPE_HOST_INFO_REQ				        ( PKT_TYPE_PUSH_TO_TALK_STOP + 1 )		       	// 107 ( 0x6B ) 
#define PKT_TYPE_HOST_INFO_REPLY			        ( PKT_TYPE_HOST_INFO_REQ	+ 1 )              	// 108 ( 0x6C ) 
// 109 ( 0x6D )                                                                               		
#define PKT_TYPE_HOST_INVITE_ANN_REQ				( PKT_TYPE_HOST_INFO_REPLY + 1 )		        // 109 ( 0x6D ) 
#define PKT_TYPE_HOST_INVITE_ANN_REPLY			    ( PKT_TYPE_HOST_INVITE_ANN_REQ	+ 1 )           // 110 ( 0x6E ) 
#define PKT_TYPE_HOST_INVITE_SEARCH_REQ				( PKT_TYPE_HOST_INVITE_ANN_REPLY + 1 )		    // 111 ( 0x6F )
#define PKT_TYPE_HOST_INVITE_SEARCH_REPLY			( PKT_TYPE_HOST_INVITE_SEARCH_REQ	+ 1 )       // 112 ( 0x70 )
#define PKT_TYPE_HOST_INVITE_MORE_REQ				( PKT_TYPE_HOST_INVITE_SEARCH_REPLY + 1 )		// 113 ( 0x71 ) 
#define PKT_TYPE_HOST_INVITE_MORE_REPLY			    ( PKT_TYPE_HOST_INVITE_MORE_REQ	+ 1 )           // 114 ( 0x72 )   
// 115 ( 0x73 )																						
#define PKT_TYPE_GROUPIE_INFO_REQ				    ( PKT_TYPE_HOST_INVITE_MORE_REPLY + 1 )		    // 115 ( 0x73 )  
#define PKT_TYPE_GROUPIE_INFO_REPLY			        ( PKT_TYPE_GROUPIE_INFO_REQ	+ 1 )               // 116 ( 0x74 ) 
// 117 ( 0x75 )                                                                           			
#define PKT_TYPE_GROUPIE_ANN_REQ				    ( PKT_TYPE_GROUPIE_INFO_REPLY + 1 )		        // 117 ( 0x75 )  
#define PKT_TYPE_GROUPIE_ANN_REPLY			        ( PKT_TYPE_GROUPIE_ANN_REQ	+ 1 )               // 118 ( 0x76 ) 
#define PKT_TYPE_GROUPIE_SEARCH_REQ				    ( PKT_TYPE_GROUPIE_ANN_REPLY + 1 )		       	// 119 ( 0x77 ) 
#define PKT_TYPE_GROUPIE_SEARCH_REPLY			    ( PKT_TYPE_GROUPIE_SEARCH_REQ	+ 1 )          	// 120 ( 0x78 ) 
#define PKT_TYPE_GROUPIE_MORE_REQ				    ( PKT_TYPE_GROUPIE_SEARCH_REPLY + 1 )		   	// 121 ( 0x79 )		
#define PKT_TYPE_GROUPIE_MORE_REPLY			        ( PKT_TYPE_GROUPIE_MORE_REQ	+ 1 )              	// 122 ( 0x7A )														
// 123 ( 0x7B )																						
#define PKT_TYPE_FILE_INFO_INFO_REQ				    ( PKT_TYPE_GROUPIE_MORE_REPLY + 1 )		        // 123 ( 0x7B )
#define PKT_TYPE_FILE_INFO_INFO_REPLY			    ( PKT_TYPE_FILE_INFO_INFO_REQ	+ 1 )           // 124 ( 0x7C )
// 125 ( 0x7D )                                                                                		
#define PKT_TYPE_FILE_INFO_ANN_REQ				    ( PKT_TYPE_FILE_INFO_INFO_REPLY + 1 )		    // 125 ( 0x7D )
#define PKT_TYPE_FILE_INFO_ANN_REPLY			    ( PKT_TYPE_FILE_INFO_ANN_REQ	+ 1 )           // 126 ( 0x7E )
#define PKT_TYPE_FILE_INFO_SEARCH_REQ				( PKT_TYPE_FILE_INFO_ANN_REPLY + 1 )		    // 127 ( 0x7F )
#define PKT_TYPE_FILE_INFO_SEARCH_REPLY			    ( PKT_TYPE_FILE_INFO_SEARCH_REQ	+ 1 )           // 128 ( 0x80 )
#define PKT_TYPE_FILE_INFO_MORE_REQ				    ( PKT_TYPE_FILE_INFO_SEARCH_REPLY + 1 )		    // 129 ( 0x81 )
#define PKT_TYPE_FILE_INFO_MORE_REPLY			    ( PKT_TYPE_FILE_INFO_MORE_REQ	+ 1 )           // 130 ( 0x82 )
																									
#define PKT_TYPE_MEMBERSHIP_REQ						( PKT_TYPE_FILE_INFO_MORE_REPLY + 1 )		    // 131 ( 0x83 )
#define PKT_TYPE_MEMBERSHIP_REPLY					( PKT_TYPE_MEMBERSHIP_REQ	+ 1 )				// 132 ( 0x84 )	
																									
#define PKT_TYPE_RELAY_USER_DISCONNECT				( PKT_TYPE_MEMBERSHIP_REPLY + 1 )				// 133 ( 0x85 )		
																					
#define PKT_TYPE_HOST_USER_INFO_REQ				    ( PKT_TYPE_RELAY_USER_DISCONNECT + 1 )			// 134 ( 0x86 )		 
#define PKT_TYPE_HOST_USER_INFO_REPLY			    ( PKT_TYPE_HOST_USER_INFO_REQ	+ 1 )    		// 135 ( 0x87 )		
#define PKT_TYPE_HOST_USER_STATUS_REQ			    ( PKT_TYPE_HOST_USER_INFO_REPLY	+ 1 )  			// 136 ( 0x88 )		
#define PKT_TYPE_HOST_USER_STATUS_REPLY			    ( PKT_TYPE_HOST_USER_STATUS_REQ	+ 1 )  			// 137 ( 0x89 )		

#define PKT_TYPE_HOST_USER_LIST_REQ					( PKT_TYPE_HOST_USER_STATUS_REPLY	+ 1 ) 		// 138 ( 0x8A )		 
#define PKT_TYPE_HOST_USER_LIST_REPLY				( PKT_TYPE_HOST_USER_LIST_REQ	+ 1 ) 			// 139 ( 0x8B )		 
...
#define PKT_TYPE_TEST_CONN_TEST_REPLY				( PKT_TYPE_TEST_CONN_TEST_REQ	+ 1 ) 			// 143 ( 0x8F )		
#define PKT_TYPE_TEST_CONN_PING_REQ					( PKT_TYPE_TEST_CONN_TEST_REPLY	+ 1 ) 			// 144 ( 0x90 )	
#define PKT_TYPE_TEST_CONN_PING_REPLY				( PKT_TYPE_TEST_CONN_PING_REQ	+ 1 ) 			// 145 ( 0x91 )		

#define PKT_TYPE_QUERY_HOST_URL_REQ					( PKT_TYPE_TEST_CONN_PING_REPLY + 1 ) 			// 146 ( 0x92 )		
...
// 151 ( 0x97 )                                                                              	
#define PKT_TYPE_FRIEND_REQUEST_REQ		            ( PKT_TYPE_RAND_CONNECT_REPLY + 1 )	            // 152 ( 0x98 )
#define PKT_TYPE_FRIEND_REQUEST_REPLY				( PKT_TYPE_FRIEND_REQUEST_REQ + 1 )	            // 153 ( 0x99 )

																									
#define MAX_PKT_TYPE_CNT							( PKT_TYPE_FRIEND_REQUEST_REPLY + 1 ) // 154
