...
RxSession * PluginCamClient::createRxSession( std::shared_ptr<VxSktBase>& sktBase, VxNetIdent* netIdent )
{
...
TxSession * PluginCamClient::createTxSession( std::shared_ptr<VxSktBase>& sktBase, VxNetIdent* netIdent )
{
