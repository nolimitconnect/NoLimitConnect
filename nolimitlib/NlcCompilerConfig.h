...
uint64_t GetTickCount64( void ); // implemented in VxFunctionsMissingInPosix.cpp
...
#define HAVE_CONFIG_H			1	// define so opus uses NlcDependLibrariesConfig.h local file ( most everything requires one anyway )
...
# define HAVE_INLINE_ASM		0 // visual studio does not have inline assembly for x64
#else
