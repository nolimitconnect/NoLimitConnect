...
const char* DescribeMediaError( enum EMediaError mediaError )
{
    switch( mediaError )
    {
    case eMediaErrorNone:
        return "eMediaErrorNone";
    case eMediaErrorFileNotFound:
        return "eMediaErrorFileNotFound";
    case eMediaErrorCodecNotFound:
        return "eMediaErrorCodecNotFound";
    case eMediaErrorPlayerInit:
        return "eMediaErrorPlayerInit";
    case eMediaErrorPlayerAssetNotFound:
        return "eMediaErrorPlayerAssetNotFound";

    default:
        return "UNKNOWN EMediaError";
    }
}
...
const char* DescribeMediaPlayerAction( enum EMediaPlayerAction playerAction )
{
    switch( playerAction )
    {
    case eMediaPlayerActionNone: return "eMediaPlayerActionNone";
    case eMediaPlayerActionClose: return "Player Close";
    case eMediaPlayerActionOpen: return "Player Open";
    case eMediaPlayerActionPlayPause: return "Play Pause";
