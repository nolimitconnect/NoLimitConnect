...
# else
#  if defined HAVE_ALLOCA_H || defined _LIBC_GNU
...
#if defined HAVE_UNISTD_H || defined _LIBC_GNU
# include <unistd.h>
#endif
...
#if defined HAVE_SYS_PARAM_H || defined _LIBC_GNU
# include <sys/param.h>
#endif

#if !defined _LIBC_GNU
...
/* Use a replacement if the system does not provide the `tsearch' function
   family.  */
#if defined HAVE_TSEARCH || defined _LIBC_GNU
# include <search.h>
#else
...
#if defined _LIBC_GNU || HAVE_USELOCALE || defined IN_LIBGLOCALE
...
#endif
#if (defined _LIBC_GNU || HAVE_ICONV) && !defined IN_LIBGLOCALE
...
#if defined _LIBC_GNU || HAVE_ICONV
# ifdef IN_LIBGLOCALE
  if (encoding != NULL)
# else
  if (convert)
...
# if defined _LIBC_GNU || HAVE_MEMPCPY
...
# endif
  ...
  if (language != NULL && language[0] != '\0')
    return language;
#if !defined IN_LIBGLOCALE && !defined _LIBC_GNU
