...
class PluginBaseNetworkService : public PluginNetServices
{
public:
    PluginBaseNetworkService( P2PEngine& engine, PluginMgr& pluginMgr, VxNetIdent* myIdent, EPluginType pluginType );
    virtual ~PluginBaseNetworkService() override = default;
    ...
    virtual bool                ptopEngineRequestPluginThumb    ( std::shared_ptr<VxSktBase>& sktBase, VxNetIdent* netIdent, VxGUID& thumbId, bool isTmp = false ) override;
