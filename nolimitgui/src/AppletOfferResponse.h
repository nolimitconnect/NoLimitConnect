...
class AppletOfferResponse : public AppletBase, public ToGuiFileXferInterface
{
	Q_OBJECT
public:
	AppletOfferResponse( AppCommon& app, QWidget* parent, QString launchParam = "" );
	virtual ~AppletOfferResponse();
