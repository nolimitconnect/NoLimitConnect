...
class VxPushButton : public QPushButton
{
	Q_OBJECT
public:
	VxPushButton(QWidget* parent=nullptr);
	VxPushButton(const QString &text, QWidget* parent=nullptr);
    ...
    void						setEyeOverlayEnabled( bool enabled, EMyIcons eNotifyIcon = eMyIconEyeOverlay );
    ...
    void						clearIconOverrideColor( void );
	...
	void						setIcons( EMyIcons normalIcon, EMyIcons	overlay1Icon = eMyIconNone );
...
protected:
    ...
    QSize						m_NotifyLastIconForbiddenSize{ 0, 0 };
    ...
    bool						m_EyeOverlayEnabled{ false };
    EMyIcons					m_EyeOverlayIcon{ eMyIconNone };
    EMyIcons					m_LastEyeOverlayIcon{ eMyIconNone };
    QPixmap						m_EyeOverlayImage;
    QColor						m_EyeOverlayColor;
    QColor						m_EyeOverlayLastIconColor;
    QSize						m_EyeOverlayLastIconSize{ 0, 0 };
	...
	QSize						m_OverlayLastIconSize{ 0, 0 };
    ...
    EPushToTalkStatus           m_PushToTalkStatus{ ePushToTalkStatusInvalid };
};
