...
QString MyIcons::getIconFile( enum EMyIcons eMyIcon )
{
	...
	case eMyIconEyeAnnouncedChatRooms:
		return ":/AppRes/Resources/eye-announced-chat-rooms.svg";
	case eMyIconEyeAnnouncedGroups:
		return ":/AppRes/Resources/eye-announced-groups.svg";
	case eMyIconEyeAnnouncedRandomConnect:
		return ":/AppRes/Resources/eye-announced-random-connect.svg";
	...
	case eMyIconEyeSearchDisabled:
		return ":/AppRes/Resources/eye-search-disabled.svg";
	case eMyIconEyeSearchEnabled:
		return ":/AppRes/Resources/eye-search-enabled.svg";
    case eMyIconEyeShow:
	...
	case eMyIconOfferHistory:
		return ":/AppRes/Resources/offer-history.svg";
	...
	case eMyIconAboutMeEdit:
		return ":/AppRes/Resources/about-me-edit.svg";
	case eMyIconStoryboardEdit:
		return ":/AppRes/Resources/storyboard-edit.svg";

	case eMyIconOfferEye:
		return ":/AppRes/Resources/offer-eye.svg";	

	case eMyIconUserPreferences:
		return ":/AppRes/Resources/user-preferences.svg";
	...
	case eMyIconLanguageSelect:
		return ":/AppRes/Resources/language-change.svg";
...
EMyIcons MyIcons::getPluginSettingsIcon( enum EPluginType pluginType )
{
    switch( pluginType )
    {
...
//============================================================================
//! get icon for given plugin
EMyIcons MyIcons::getPluginIcon( enum EPluginType pluginType, EPluginAccess ePluginAccess )
{
	switch( pluginType )
	{
...
EMyIcons MyIcons::getPluginSetupIcon( enum EPluginType pluginType)
{
    switch( pluginType )
    {
    case ePluginTypeAboutMePageServer:
...
EMyIcons MyIcons::getDisabledPluginIcon( enum EPluginType pluginType )
{
	switch( pluginType )
	{
	case	ePluginTypeAboutMePageServer:
...
EMyIcons MyIcons::getLockedPluginIcon( enum EPluginType pluginType )
{
	switch( pluginType )
	{
	case	ePluginTypeAboutMePageServer:
...
//============================================================================
EMyIcons MyIcons::getIgnoredPluginIcon( enum EPluginType pluginType )
{
	switch( pluginType )
	{
	case	ePluginTypeAboutMePageServer:
...
//============================================================================
EMyIcons MyIcons::getOfferIcon( OfferBaseInfo& offerInfo, enum EPluginType pluginType )
{
	EMyIcons myIcon{ eMyIconUnknown };
	if( IsHostOrClientPluginType( pluginType ) || IsPluginSingleSession( pluginType ) )
	{
		myIcon = getPluginIcon( pluginType );
	}

	if( eMyIconUnknown == myIcon && offerInfo.isFileAsset() )
	{
		myIcon = getFileIcon( (uint8_t)offerInfo.getAssetType() );
	}

	if( eMyIconUnknown == myIcon && offerInfo.isChatTextAsset() )
	{
		myIcon = getFileIcon( (uint8_t)offerInfo.getAssetType() );
	}
...
//============================================================================
EMyIcons MyIcons::getHostTypeHostIcon( enum EHostType hostType )
{
	switch( hostType )
	{
...
//============================================================================
EMyIcons MyIcons::getHostTypeClientIcon( enum EHostType hostType )
{
	switch( hostType )
	{
	case eHostTypeConnectTest:
