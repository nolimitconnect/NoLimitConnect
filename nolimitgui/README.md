...
```
cd existing_repo
git remote add origin https://gitlab.com/nolimitcode/nolimitconnect.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/nolimitcode/nolimitconnect/-/settings/integrations)
