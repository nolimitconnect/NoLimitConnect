...
```
cd existing_repo
git remote add origin https://gitlab.com/nolimitconnect/NoLimitConnect.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/nolimitconnect/NoLimitConnect/-/settings/integrations)
