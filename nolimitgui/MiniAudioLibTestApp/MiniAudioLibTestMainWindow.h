...
#include "ui_MiniAudioLibTestMainWindow.h"

class AppCommon;

class MiniAudioLibTestMainWindow : public QMainWindow
{
	Q_OBJECT
public:
	MiniAudioLibTestMainWindow( AppCommon& app, QWidget* parent = nullptr );
	virtual ~MiniAudioLibTestMainWindow() override;
...
protected slots:
    ...
    // void                        slotMiniAudioLibEnableChange( int checkState );
    ...
    void                        slotDirectMicToSpeakerCheckBox( int checkState );

    void                        slotWantSpeakerCheckBox( int checkState );
    void                        slotMuteSpeakerCheckBox( int checkState );
    void                        slotMiniAudioLibEnableCheckBox( int checkState );
...
protected:
    ...
    //=== vars ===//
    Ui::MiniAudioLibTestMainWindowUi   ui;
    AppCommon&                  m_MyApp;
