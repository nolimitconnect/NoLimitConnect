...
//============================================================================
void INlc::toGuiMediaError( EAppModule appModule, EMediaError mediaError, const char* msg )
{
    getAppCommon().toGuiMediaError( appModule, mediaError, msg );
}
...
//============================================================================
void INlc::createTextureObject( CTextureQt * texture )
{
    getAppCommon().createTextureObject( texture );
}

//============================================================================
void INlc::destroyTextureObject( CTextureQt * texture )
{
    getAppCommon().destroyTextureObject( texture );
}

//============================================================================
bool INlc::loadToGPU( CTextureQt * texture )
{
   return getAppCommon().loadToGPU( texture );
}

//============================================================================
void INlc::bindToUnit( CTextureQt * texture, unsigned int unit )
{
...
//============================================================================
void INlc::drawQuad( const NlcRect& rect, NlcColor color, CTextureBase * texture, const NlcRect * texCoords )
{
