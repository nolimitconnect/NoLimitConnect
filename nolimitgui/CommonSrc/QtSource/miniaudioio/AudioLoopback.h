...
public:
	...
	virtual int					readRequestFromSpeaker( int16_t* pcmData, int sampleCnt ) override;
	...
	void						writeProcessedSamples( int16_t* pcmData, int sampleCnt );
...
protected:
	...
	int                         getMixerFrameSize( void )							{ return AUDIO_BUF_SIZE; }
