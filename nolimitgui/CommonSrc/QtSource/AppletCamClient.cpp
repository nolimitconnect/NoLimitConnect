...
//============================================================================
void AppletCamClient::slotToGuiRxedOfferReply( std::shared_ptr<GuiOfferSession> offerReply )
{
...
//============================================================================
void AppletCamClient::slotToGuiSessionEnded( std::shared_ptr<GuiOfferSession> offer )
{
