...
, m_CloseAppletTimer( new QTimer( this ) )
{
    ...
    ui.m_ListDescriptionLabel->setText( QObject::tr( "Chat Room Hosts Announced To Network Host" ) );
    setStatusLabel( QObject::tr( "Chat Room Hosts Announced To Network Host" ) );
    ...
    {
        okMessageBox( QObject::tr( "Service Unavailable" ), QObject::tr( "Network Host Service Is Not Enabled. You can not view chat rooms announced to this device because the service is not enabled" ) );
...
//============================================================================
AppletChatRoomListLocalView::~AppletChatRoomListLocalView()
{
    m_MyApp.getHostedListMgr().wantHostedListCallbacks( this, false );
}

//============================================================================
void AppletChatRoomListLocalView::setStatusLabel( QString strMsg )
{
    ui.m_StatusLabel->setText( strMsg );
}

//============================================================================
void AppletChatRoomListLocalView::setInfoLabel( QString strMsg )
{
...
//============================================================================
void AppletChatRoomListLocalView::slotHomeButtonClicked( void )
{
}

//============================================================================
void AppletChatRoomListLocalView::slotRefreshGroupList( void )
{
...
//============================================================================
void AppletChatRoomListLocalView::slotSearchComplete( void )
{
    //ui.m_SearchsParamWidget->slotSearchComplete();
}

//============================================================================
void AppletChatRoomListLocalView::slotInfoMsg( const QString& text )
{
    setStatusLabel( text ); // Adds the message to the widget                                                                                              //m_LogFile.write( text ); // Logs to file
}

//============================================================================
void AppletChatRoomListLocalView::slotHostAnnounceStatus( EHostType hostType, VxGUID sessionId, EHostAnnounceStatus hostStatus, QString text )
{
    setInfoLabel( GuiParams::describeStatus(hostStatus) + text);
}

//============================================================================
void AppletChatRoomListLocalView::slotHostJoinStatus( EHostType hostType, VxGUID sessionId, EHostJoinStatus hostStatus, QString text )
{
    setInfoLabel( GuiParams::describeStatus(hostStatus) + text);
}

//============================================================================
void AppletChatRoomListLocalView::slotHostSearchStatus( EHostType hostType, VxGUID sessionId, EHostSearchStatus hostStatus, QString strMsg )
{
...
//============================================================================
void AppletChatRoomListLocalView::toGuiInfoMsg( char * infoMsg )
{
...
//============================================================================
void AppletChatRoomListLocalView::infoMsg( const char* errMsg, ... )
{
...
//============================================================================
void AppletChatRoomListLocalView::clearPluginSettingToList( void )
{
    ui.m_HostedListWidget->clearHostList();
}

//============================================================================
void AppletChatRoomListLocalView::clearStatus( void )
{
    setInfoLabel( "" );
    setStatusLabel( "" );
}
...
//============================================================================
void AppletChatRoomListLocalView::slotIconButtonClicked( GuiHostSession* hostSession, GuiHostedListItem* hostItem )
{

}

//============================================================================
void AppletChatRoomListLocalView::slotMenuButtonClicked( GuiHostSession* hostSession, GuiHostedListItem* hostItem )
{

}

//============================================================================
void AppletChatRoomListLocalView::slotJoinButtonClicked( GuiHostSession* hostSession, GuiHostedListItem* hostItem )
{
...
//============================================================================
void AppletChatRoomListLocalView::callbackGuiHostedListSearchResult( HostedId& hostedId, GuiHosted* guiHosted, VxGUID& sessionId )
{
    LogMsg( LOG_DEBUG, "AppletChatRoomListLocalView::callbackGuiHostedListSearchResult host %s title %s", DescribeHostType( hostedId.getHostType() ), guiHosted->getHostTitle().c_str() );
...
//============================================================================
void AppletChatRoomListLocalView::updateHostedList( HostedId& hostedId, GuiHosted* guiHosted, VxGUID& sessionId )
{
    ui.m_HostedListWidget->updateHostedList( hostedId, guiHosted, sessionId );
}

//============================================================================   
void AppletChatRoomListLocalView::onCancelButClick( void )
{
    onBackButtonClicked();
}
