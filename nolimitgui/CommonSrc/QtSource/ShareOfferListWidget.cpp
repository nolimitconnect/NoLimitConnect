...
, m_OfferMgr( m_MyApp.getOfferMgr() )
{
    ...
    /*
    connect( &m_OfferMgr, SIGNAL(signalMyIdentUpdated( GuiOffer*)),           this, SLOT(callbackMyIdentUpdated( GuiOffer*))) ;
...
{
    ShareOfferListItem* userItem = findListEntryWidgetBySessionId( userSession->getOfferSessionId() );
    if( userItem )
    {
...
void ShareOfferListWidget::refreshList( void )
{
    ...
    for( auto offerSession : m_OfferMgr.getOfferList() )
    {
