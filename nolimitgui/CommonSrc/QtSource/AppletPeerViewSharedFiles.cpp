//============================================================================
// Copyright (C) 2013 Brett R. Jones - Issued to proprietary license in 2022
// Issued to MIT style license by Brett R. Jones - Issued to proprietary license in 2022 in 2017
//
...
//============================================================================
void AppletPeerViewSharedFiles::toGuiFileXferState( EPluginType pluginType, VxGUID& lclSessionId, EXferDirection xferDir, EXferState xferState, EXferError xferErr, int param1 )
{
