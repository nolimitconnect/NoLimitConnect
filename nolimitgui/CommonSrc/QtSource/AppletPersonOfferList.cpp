...
//============================================================================
void AppletPersonOfferList::toGuiFileDownloadStart( GuiFileXferSession* xferSession )
{
	Q_UNUSED( userData );
...
//============================================================================
void AppletPersonOfferList::toGuiFileXferState( EPluginType pluginType,  VxGUID& lclSessionId, EXferDirection xferDir, EXferState xferState, EXferError xferErr, int param1 )
{
	Q_UNUSED( userData );
