...
enum EThemeColorRole
{
	...
	eLayerNotifyRelayedColor,
	eLayerNotifyOfflineColor,
    eLayerNotifyOfferColor, 
    eLayerNotifyForbiddenColor, 
    eLayerNotifyErrorColor, // also used for needs attention
...
public:
	...
	virtual void				selectTheme( EThemeType eThemeType, QWidget* homeHindow );
	...
	virtual QColor				getAcceptColor( void );
	virtual QColor				getCancelColor( void );
