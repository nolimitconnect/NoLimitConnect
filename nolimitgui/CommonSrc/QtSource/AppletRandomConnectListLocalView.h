...
QT_BEGIN_NAMESPACE
namespace Ui {
    class AppletRandomConnectListLocalViewUi;
}
QT_END_NAMESPACE
...
class AppletRandomConnectListLocalView : public AppletClientBase, public GuiHostedListCallback
{
	Q_OBJECT
public:
	AppletRandomConnectListLocalView( AppCommon& app, QWidget*	parent = nullptr );
	virtual ~AppletRandomConnectListLocalView();
...
protected:
    ...
    //=== vars ===//
    Ui::AppletRandomConnectListLocalViewUi& ui;
