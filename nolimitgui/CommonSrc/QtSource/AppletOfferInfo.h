...
class AppletOfferInfo : public AppletBase, public ToGuiFileXferInterface
{
	Q_OBJECT
public:
	AppletOfferInfo( AppCommon& app, QWidget* parent, QString launchParam = "" );
	virtual ~AppletOfferInfo();
