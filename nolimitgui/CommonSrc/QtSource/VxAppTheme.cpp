...
//============================================================================
QColor VxAppTheme::getAcceptColor( void )
{
    return QColor( COLOR_GREEN );
}
//============================================================================
QColor VxAppTheme::getCancelColor( void )
{
    return QColor( COLOR_RED );
}

//============================================================================
QColor VxAppTheme::getNotifyColor( ENotifyType notifyType )
{
    switch( notifyType )
    {
    case eNotifyOffline:
        return getColor( eLayerNotifyOfflineColor );
    case eNotifyOnline: 
        return getColor( eLayerNotifyOnlineColor );
    case eNotifyRelayed: 
        return getColor( eLayerNotifyRelayedColor );
...
//============================================================================
void VxAppTheme::updateWindowTheme( QWidget* homeHindow )
{
...
/*
 ...
 /*   enum ColorRole {
    ...
    */
    ...
    if( homeHindow )
    {
        homeHindow->setPalette( palette );
    }
}

//============================================================================
void VxAppTheme::selectTheme( EThemeType eThemeType, QWidget* homeHindow )
{
