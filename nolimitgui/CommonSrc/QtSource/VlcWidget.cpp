...
//============================================================================
MyIcons&  VlcWidget::getMyIcons( void )
{
	return m_MyApp.getMyIcons();
}

//============================================================================
VxLabel * VlcWidget::getVideoScreen( void )
{
	return ui.m_VideoScreen;
}

//============================================================================
void VlcWidget::setAspectRatio( float aspectRatio )
{
    ui.m_VideoFrame->setVideoScreenAspectRatio( aspectRatio );
}

//============================================================================
void VlcWidget::setVideoFeedId( VxGUID& feedOnlineId, EAppModule appModule )
{ 
...
//============================================================================
void VlcWidget::showOfflineImage( void )
{
	ui.m_VideoScreen->setImageFromFile( ":/AppRes/Resources/web_cam_buffering.png" );
}

//============================================================================
void VlcWidget::showUserMsgLabel( bool showCtrls )
{
    ui.m_UserMsgLabel->setVisible( showCtrls );
}

//============================================================================
void VlcWidget::showAllControls( bool showCtrls )
{
...
//============================================================================
void VlcWidget::enableVidFilesButton( bool enable )
{
	ui.m_VidFilesButton->setEnabled( enable );
}

//============================================================================
void VlcWidget::enableCamSourceControls( bool enable )
{
...
//============================================================================
void VlcWidget::enableCamFeedControls( bool enable )
{
	ui.m_ImageRotateButton->setEnabled( enable );
}

//============================================================================
void VlcWidget::showFeedControls( bool showCtrls )
{
	ui.m_VidCtrlFrame->setVisible( showCtrls );
}

//============================================================================
bool VlcWidget::isFeedControlsVisible( void )
{
	return ui.m_VidCtrlFrame->isVisible();
}

//============================================================================
void VlcWidget::showRecordControls( bool showCtrls )
{
...
//============================================================================
bool VlcWidget::isRecordControlsVisible( void )
{
	return ui.m_RecordCtrlFrame->isVisible();
}

//============================================================================
void VlcWidget::showMotionSensitivityControls( bool showCtrls )
{
	ui.m_RecordSensitivityFrame->setVisible( showCtrls );
}

//============================================================================
bool VlcWidget::isMotionSensitivityControlsVisible( void )
{
	return ui.m_RecordSensitivityFrame->isVisible();
}

//============================================================================
void VlcWidget::setVidImageRotation( int imageRotation )
{
	ui.m_VideoScreen->setVidImageRotation( imageRotation );
}

//============================================================================
int VlcWidget::getVidImageRotation( void )
{
	return ui.m_VideoScreen->getVidImageRotation();
}

//============================================================================
void VlcWidget::slotStatusMsg( QString userMsg )
{
	ui.m_UserMsgLabel->setText( userMsg );
}

//============================================================================
void VlcWidget::slotWidgetClicked( void )
{
	emit clicked();
...
//============================================================================
void VlcWidget::slotCamPreviewButtonClicked( void )
{
	if( !m_DisablePreview )
	{
...
//============================================================================
void VlcWidget::updatePreviewVisibility( void )
{
...
//============================================================================
void VlcWidget::slotFeedRotateButtonClicked( void )
{
...
//============================================================================
void VlcWidget::updateVidFeedImageRotation( void )
{
	int feedRotation = m_AppSettings.getVidFeedRotation();
...
//============================================================================
void VlcWidget::slotCamRotateButtonClicked( void )
{
...
//============================================================================
void VlcWidget::disablePreview( bool disable )
{
...
//============================================================================
bool VlcWidget::setImageFromFile( QString fileName )
{
	return ui.m_VideoScreen->setImageFromFile( fileName );
}

//============================================================================
void VlcWidget::callbackGuiPlayMotionVideoFrame( VxGUID& feedOnlineId, QImage& vidFrame, int motion0To100000 )
{
	if( feedOnlineId == m_VideoFeedId )
	{
...
//============================================================================
void VlcWidget::callbackGuiPlayVideoFrame( VxGUID& onlineId, QImage& vidFrame )
{
	 ui.m_VideoScreen->playVideoFrame( vidFrame );
}

//============================================================================
void VlcWidget::showEvent( QShowEvent* ev )
{
...
//============================================================================
void VlcWidget::hideEvent( QHideEvent* ev )
{
...
//============================================================================
void VlcWidget::slotIconToggleTimeout( void )
{
...
//============================================================================
void VlcWidget::slotMotionAlarmTimeout( void )
{
...
//============================================================================
void VlcWidget::slotMotionRecordTimeout( void )
{
...
//============================================================================
void VlcWidget::updateVidFeedMotion( int motion0To100000 )
{
...
//============================================================================
void VlcWidget::updateMotionBarColor( void )
{
...
//============================================================================
void VlcWidget::playMotionAlarm( void )
{
	m_MyApp.playSound( eSndDefAlarmPleasant );
}

//============================================================================
void VlcWidget::slotVidFilesButtonClicked( void )
{
	if( !m_MotionRecordOn
		&& !m_InNormalRecord )
	{
	...
	{
		LogMsg( LOG_ERROR, "VlcWidget::slotVidFilesButtonClicked dont launch Library Activity while recording" );
	}
}

//============================================================================
void VlcWidget::slotPictureSnapshotButton( void )
{
	QImage photoImage = getVideoScreen()->getLastVideoImage();
	if( photoImage.isNull() )
	{
		m_MyApp.playSound( eSndDefIgnore );
		LogMsg( LOG_ERROR, "VlcWidget::slotPictureSnapshotButton video image is null\n" );
...
//============================================================================
void VlcWidget::slotMotionAlarmButtonClicked( void )
{
	if( m_MotionAlarmOn )
	{
		m_MotionAlarmExpireTimer->stop();
...
//============================================================================
void VlcWidget::slotRecMotionButtonClicked( void )
{
	if( !m_InNormalRecord )
	{
		if( !m_RecFilePath.isEmpty() )
		{
			...
			if( m_MotionRecordOn )
			{
				...
				if( 5000 > fileLen )
				{
					...
					LogMsg( LOG_ERROR, "VlcWidget::videoMotionRecord file %s has to short len %" PRId64 "", m_RecFileName.toUtf8().constData(), fileLen );
...
//============================================================================
void VlcWidget::slotRecNormalButtonClicked( void )
{
	if( !m_MotionRecordOn )
	{
		if( !m_RecFilePath.isEmpty() )
		{
			if( m_InNormalRecord )
			{
				...
				if( 5000 > fileLen )
				{
					// not long enough to be a recording
					VxFileUtil::deleteFile( m_RecFileName.toUtf8().constData() );
					LogMsg( LOG_ERROR, "VlcWidget::videoRecord file %s has to short len %" PRId64 "", m_RecFileName.toUtf8().constData(), fileLen );
