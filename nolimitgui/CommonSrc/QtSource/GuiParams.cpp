...
namespace
{
    static const int            TINY_PUSHBUTTON_SIZE = 17;
    static const int            SMALL_PUSHBUTTON_SIZE = 22;
...
{
    return getButtonSize( eButtonSizeLarge ).height() + 14;
}
...
QString GuiParams::describePluginAction( GuiUser* guiUser, EPluginType pluginType, EPluginAccess ePluginAccess )
{
    QString strAction;
    switch( pluginType )
    {
    ...
    case ePluginTypePersonFileXfer:	// file offer plugin
        ...
        case ePluginAccessOk:			// plugin access allowed
            strAction = QObject::tr("Offer Send A File");
            break;
    ...
    case ePluginTypeVoicePhone:	// VOIP p2p plugin
        ...
        {
        case ePluginAccessOk:			// plugin access allowed
            strAction = QObject::tr("Offer Voice Call");
            break;
        case ePluginAccessLocked:		// insufficient Friend permission level
...
//============================================================================
//! Describe plugin
QString GuiParams::describePluginType( EPluginType pluginType )
{
...
//============================================================================
std::string GuiParams::describePlugin( EPluginType pluginType, bool rmtInitiated )
{
...
//============================================================================
QString GuiParams::describePluginOffer( EPluginType pluginType )
{
...
QString GuiParams::describeJoinState( EJoinState joinState )
{
    ...
    case eJoinStateJoinRequested:
        return  QObject::tr( "Join Requested " );
    case eJoinStateJoinWasGranted:
        return  QObject::tr( "Join Was Accepted " );
    case eJoinStateJoinIsGranted:
        return  QObject::tr( "Join Is Accepted " );
    case eJoinStateJoinDenied:
        return  QObject::tr( "Join Denied " );
    case eJoinStateJoinLeaveHost:
...
//============================================================================
int GuiParams::getVertScrollBarWidth( void )
{
    return 24;
}

//============================================================================
QString GuiParams::describeExpireTime( enum EExpireTime expireTime )
{
    switch( expireTime )
    {
    case eExpireTimeWhenResponseRxed:
        return QObject::tr( "When Recieve Response" );
    case eExpireTime20Seconds:
        return QObject::tr( "20 Seconds" );
    case eExpireTime1Min:
        return QObject::tr( "1 Minute" );
    case eExpireTime10Min:
        return QObject::tr( "10 Minutes" );
    case eExpireTime1Hour:
        return QObject::tr( "1 Hour" );
    case eExpireTime24Hour:
        return QObject::tr( "24 Hours" );
    case eExpireTime1Week:
        return QObject::tr( "1 Week" );
    case eExpireTime1Month:
        return QObject::tr( "1 Month" );
    case eExpireTime1Year:
        return QObject::tr( "1 Year" );

    default:
        return QObject::tr( "Unknown Expire Time " );
    }
}

//============================================================================
int GuiParams::getExpireTimeSeconds( enum EExpireTime expireTime )
{
    switch( expireTime )
    {
    case eExpireTimeWhenResponseRxed:
...
//============================================================================
QString GuiParams::describeOfferViewType( enum EOfferViewType offerViewType )
{
    switch( offerViewType )
    {
    case eOfferViewTypeActive:
        return QObject::tr( "Active Offers " );
    case eOfferViewTypeHistory:
        return QObject::tr( "Offer History " );
