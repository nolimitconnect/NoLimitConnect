...
, m_LogMgr( GetLogMgrInstance() )
{
    ...
    m_LogModuleList.push_back( ui.m_LogModuleCheckBox_27 );
    m_LogModuleList.push_back( ui.m_LogModuleCheckBox_28 );
    m_LogModuleList.push_back( ui.m_LogModuleCheckBox_29 );
    m_LogModuleList.push_back( ui.m_LogModuleCheckBox_30 );
