...
//============================================================================
void AudioEchoCancel::processEchoCancelThreaded( AudioSpeakerBuf& speakerProcessedBuf, QMutex& speakerProcessedMutex )
{
	m_AudioEchoCancelImpl.processEchoCancelThreaded( speakerProcessedBuf, speakerProcessedMutex );
}
