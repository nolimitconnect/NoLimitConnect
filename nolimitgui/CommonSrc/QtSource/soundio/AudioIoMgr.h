...
public:
    ...
    void                        setUseFixedAudioOutBufferSize( bool useFixedSize )  { m_UseFixedAudioOutBufferSize = useFixedSize; }
    bool                        getUseFixedAudioOutBufferSize( void )               { return m_UseFixedAudioOutBufferSize; }
