...
set(CPACK_NSIS_INSTALLED_ICON_NAME "NoLimitConnect.exe")
set(CPACK_NSIS_MUI_ICON "${PROJECT_SRC_ROOT_DIR}/nolimitgui/src/Resources/favicon.ico")
set(CPACK_NSIS_MUI_UNIICON "${PROJECT_SRC_ROOT_DIR}/nolimitgui/src/Resources/favicon.ico")
set(CPACK_PACKAGE_FILE_NAME "${INSTALLER_FILENAME}")
set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY "${NLC_NAME}")
set(CPACK_NSIS_EXTRA_INSTALL_COMMANDS "SetRegView 32\nWriteRegStr HKLM \\\"Software\\\\Microsoft\\\\Windows\\\\CurrentVersion\\\\Uninstall\\\\${CPACK_PACKAGE_INSTALL_REGISTRY_KEY}\\\" \\\"DisplayName\\\" \\\"NoLimitConnect\\\"\nWriteRegStr HKLM \\\"Software\\\\Microsoft\\\\Windows\\\\CurrentVersion\\\\Uninstall\\\\${CPACK_PACKAGE_INSTALL_REGISTRY_KEY}\\\" \\\"Publisher\\\" \\\"NoLimitConnect\\\"\nWriteRegStr HKLM \\\"Software\\\\Microsoft\\\\Windows\\\\CurrentVersion\\\\Uninstall\\\\${CPACK_PACKAGE_INSTALL_REGISTRY_KEY}\\\" \\\"DisplayIcon\\\" \\\"$INSTDIR\\\\NoLimitConnect.exe,0\\\"\nWriteRegStr HKCU \\\"Software\\\\Microsoft\\\\Windows\\\\CurrentVersion\\\\Uninstall\\\\${CPACK_PACKAGE_INSTALL_REGISTRY_KEY}\\\" \\\"DisplayName\\\" \\\"NoLimitConnect\\\"\nWriteRegStr HKCU \\\"Software\\\\Microsoft\\\\Windows\\\\CurrentVersion\\\\Uninstall\\\\${CPACK_PACKAGE_INSTALL_REGISTRY_KEY}\\\" \\\"Publisher\\\" \\\"NoLimitConnect\\\"\nWriteRegStr HKCU \\\"Software\\\\Microsoft\\\\Windows\\\\CurrentVersion\\\\Uninstall\\\\${CPACK_PACKAGE_INSTALL_REGISTRY_KEY}\\\" \\\"DisplayIcon\\\" \\\"$INSTDIR\\\\NoLimitConnect.exe,0\\\"\nSetRegView 64\nWriteRegStr HKLM \\\"Software\\\\Microsoft\\\\Windows\\\\CurrentVersion\\\\Uninstall\\\\${CPACK_PACKAGE_INSTALL_REGISTRY_KEY}\\\" \\\"DisplayName\\\" \\\"NoLimitConnect\\\"\nWriteRegStr HKLM \\\"Software\\\\Microsoft\\\\Windows\\\\CurrentVersion\\\\Uninstall\\\\${CPACK_PACKAGE_INSTALL_REGISTRY_KEY}\\\" \\\"Publisher\\\" \\\"NoLimitConnect\\\"\nWriteRegStr HKLM \\\"Software\\\\Microsoft\\\\Windows\\\\CurrentVersion\\\\Uninstall\\\\${CPACK_PACKAGE_INSTALL_REGISTRY_KEY}\\\" \\\"DisplayIcon\\\" \\\"$INSTDIR\\\\NoLimitConnect.exe,0\\\"\nWriteRegStr HKCU \\\"Software\\\\Microsoft\\\\Windows\\\\CurrentVersion\\\\Uninstall\\\\${CPACK_PACKAGE_INSTALL_REGISTRY_KEY}\\\" \\\"DisplayName\\\" \\\"NoLimitConnect\\\"\nWriteRegStr HKCU \\\"Software\\\\Microsoft\\\\Windows\\\\CurrentVersion\\\\Uninstall\\\\${CPACK_PACKAGE_INSTALL_REGISTRY_KEY}\\\" \\\"Publisher\\\" \\\"NoLimitConnect\\\"\nWriteRegStr HKCU \\\"Software\\\\Microsoft\\\\Windows\\\\CurrentVersion\\\\Uninstall\\\\${CPACK_PACKAGE_INSTALL_REGISTRY_KEY}\\\" \\\"DisplayIcon\\\" \\\"$INSTDIR\\\\NoLimitConnect.exe,0\\\"")
